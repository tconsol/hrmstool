  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center pt-24">
        ...
        {/* Heading */}
        <h1 className="text-6xl md:text-7xl lg:text-8xl font-black tracking-tight leading-none mb-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
          <button
            ...
            className="group flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-xl font-semibold text-lg shadow-xl shadow-blue-500/30 hover:shadow-blue-500/50 hover:scale-105 transition-all duration-200"
          >
            Start Free Trial
          ...
          <button
            ...
            className="flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-lg border border-white/10 text-gray-300 hover:bg-white/5 hover:border-white/20 transition-all duration-200"
          >
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="relative rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-sm overflow-hidden p-6">
            {/* Fake browser bar */}
            ...
            <div className="grid grid-cols-4 gap-3 mb-3">
              {[
                ...
                <div key={s.label} className={`bg-gradient-to-br ${s.color} border border-white/5 rounded-xl p-4`}>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="col-span-2 bg-white/[0.03] border border-white/5 rounded-xl p-4 h-28 flex items-end gap-1">
              ...
              <div className="bg-white/[0.03] border border-white/5 rounded-xl p-4 h-28">

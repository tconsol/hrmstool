...
function validateMagicBytes(buffer, mimeType) {
  ...
  const signatures = {
    ...
    'image/webp': null, // Check RIFF + WEBP
...
/**
 * Generate a signed URL for reading a document.
...
/**
 * Delete all files in a folder (prefix) in GCP Cloud Storage.
 * Used when removing an employee's entire document folder.
 */
